...
MODEL                := lab_1
MODULES              := lab_1_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := lab_1.mk
...
#
MODELLIB                  := lab_1lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := lab_1_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;G:/lab_CSCib/lab_1/lab_1_sldrt_win32;G:/lab_CSCib/lab_1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
