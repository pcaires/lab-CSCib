...
#ifndef RTW_HEADER_lab2_h_
#define RTW_HEADER_lab2_h_
#include <math.h>
#include <string.h>
#ifndef lab2_COMMON_INCLUDES_
# define lab2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* lab2_COMMON_INCLUDES_ */

#include "lab2_types.h"
...
#define lab2_rtModel                   RT_MODEL_lab2_T
...
typedef struct {
  ...
  real_T Gain5[6];                     /* '<S1>/Gain5' */
  real_T Sum2[6];                      /* '<S1>/Sum2' */
} B_lab2_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T DiscreteStateSpace_DSTATE[6]; /* '<Root>/Discrete State-Space' */
  real_T Delay_DSTATE[6];              /* '<S1>/Delay' */
...
#define rtB                            lab2_B
#define BlockIO                        B_lab2_T
#define rtP                            lab2_P
#define Parameters                     P_lab2_T
#define rtDWork                        lab2_DW
#define D_Work                         DW_lab2_T
...
struct P_lab2_T_ {
  real_T A[36];                        /* Variable: A
                                        ...
                                        *   '<S1>/Gain5'
                                        */
  real_T B[6];                         /* Variable: B
                                        * Referenced by:
                                        *   '<Root>/Discrete State-Space'
                                        *   '<S1>/Gain2'
                                        */
  real_T C[6];                         /* Variable: C
                                        * Referenced by:
                                        *   '<Root>/Discrete State-Space'
                                        *   '<Root>/Gain2'
                                        *   '<S1>/Gain3'
...
extern P_lab2_T lab2_P;

/* Block signals (auto storage) */
extern B_lab2_T lab2_B;

/* Block states (auto storage) */
extern DW_lab2_T lab2_DW;

/* External data declarations for dependent source files */
extern const real_T lab2_RGND;         /* real_T ground */

/* Model entry point functions */
extern void lab2_initialize(void);
extern void lab2_output(void);
extern void lab2_update(void);
extern void lab2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab2_rtModel *lab2(void);
...
extern RT_MODEL_lab2_T *const lab2_M;
