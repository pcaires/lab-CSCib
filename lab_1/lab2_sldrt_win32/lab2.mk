...
MODEL                := lab2
MODULES              := lab2_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := lab2.mk
...
#
MODELLIB                  := lab2lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := lab2_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;G:/lab-CSCib-main/lab-CSCib-main/lab_1/lab2_sldrt_win32;G:/lab-CSCib-main/lab-CSCib-main/lab_1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
